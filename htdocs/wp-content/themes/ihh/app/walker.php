 ...
 *   <li id="menu-item-8" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8"><a
 *   href="/">Home</a></li>
 *
...
class NavWalker extends \Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
        ...
        if ( $item->is_subitem ) {
            $item_html = str_replace( '<a', '<a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button"', $item_html );
    ...
    public function cssClasses( $classes, $item ) {
        ...
        if ( $item->is_subitem ) {
            $classes[] = 'submenu menu-item-has-children';
        }
